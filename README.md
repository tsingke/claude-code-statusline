...
内置 10 套配色主题，一键切换，满足不同终端审美：

<p align="center">
  <img src="screenshots/themes-preview.svg" alt="10 种主题配色预览" width="820">
</p>
...
| **neon** | 霓虹亮色 | 🔮 品红 | 🌊 青 |
| **forest** | 自然森系：绿色/琥珀 | 🌲 绿 | 🟡 琥珀 |
| **nord** | 北极蓝灰：清爽干净 | 🧊 蓝 | 🌊 青 |
| **lavender** | 淡紫优雅：柔和护眼 | 💜 紫 | 🌊 青 |
| **gruvbox** | 复古暖调：经典配色 | 🟠 暖黄 | 🌿 绿 |
| **sakura** | 樱花粉调：精致可爱 | 🌸 粉 | 🌊 青 |
...
├── scripts/
│   ├── statusline.sh             # 状态栏核心脚本（含 10 套主题）
│   ├── statusline-config.sh      # 配置 CLI（主题/分隔符/字段开关）
│   ├── install.sh                # 自动安装脚本
│   └── uninstall.sh              # 自动卸载脚本
└── screenshots/
    ├── themes-preview.svg        # 主题配色可视化对比
