...
<p align="center">
  ...
  <br>Supports 10 color themes and per-field visibility toggling
</p>
...
- **🎨 10 color themes** — switch between various palettes for any taste
...
Switch between 10 built-in color themes:

<p align="center">
  <img src="screenshots/themes-preview.svg" alt="10 theme color comparison" width="820">
</p>
...
| **forest** | Earthy green & amber, nature-inspired | 🌲 Green | 🟡 Amber |
| **nord** | Arctic blue-grey, clean & crisp | 🧊 Blue | 🌊 Cyan |
| **lavender** | Soft purple & violet, elegant | 💜 Purple | 🌊 Cyan |
| **gruvbox** | Retro warm, vim colorscheme-inspired | 🟠 Warm yellow | 🌿 Green |
| **sakura** | Cherry blossom pink, delicate | 🌸 Pink | 🌊 Cyan |
...
├── scripts/
│   ├── statusline.sh             # Core script (with 10 themes)
